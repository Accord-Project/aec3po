...
| ifcOWL | [https://standards.buildingsmart.org/IFC/DEV/IFC4/ADD2/OWL/index.html](https://standards.buildingsmart.org/IFC/DEV/IFC4/ADD2/OWL/index.html) |_ifcowl:_ | The Industry Foundation Classes (IFC) ontology in OWL (ifcOWL) is a standardised ontology for representing building and construction information.  It is used to serve as a reference or a source of domain-specific knowledge that complements the information represented in "AEC3PO." |
